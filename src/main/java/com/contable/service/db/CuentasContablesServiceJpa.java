...
public class CuentasContablesServiceJpa implements ICuentasContablesService{
	...
	@Override
	public List<CuentaContable> buscarPorEmpresaTipoEstadoAndContieneCodigo(Empresa empresa, String tipo,
			Integer estado, String codigo) {
		return repo.findByEmpresaAndTipoAndEstadoAndCodigoContaining(empresa, tipo, estado, codigo);
	}

	@Override
	public List<CuentaContable> buscarPorEmpresaTipoAndContieneCodigo(Empresa empresa, String tipo, String valor) {
	...
	@Override
	public List<CuentaContable> buscarPorEmpresa(Empresa empresa) {
